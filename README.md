<h1 align="center">⚡ Xeo Forge V2</h1>

<p align="center">
  <strong>Autonomous AI Agent Platform with Dual Execution Modes</strong><br>
...
| `ROOT_ADMIN_EMAIL` | ✅ | — | Root admin email (seeded on init) |
| `ROOT_ADMIN_PASSWORD` | ✅ | — | Root admin password (seeded on init) |
| `MODEL_NAME` | ✅ | — | Display name for the AI model |
